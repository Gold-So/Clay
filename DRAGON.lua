...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗛𝗺𝘀 𖡨😍',url="t.me/Lu_c_i_fer"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍مطور السورس',url="t.me/Lu_c_i_fer"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{text = '𝘿𝘼W𝙎𝙃𝘼',url="t.me/Lu_c_i_fer"}},
{{text = 'ᗪEᐯ ᗩᗷᗪᗩᒪᒪᗩᕼ',url="t.me/abdosaad123"}},
{{text = 'قناه السورس',url="t.me/C_L_A_Y_12"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
{{text = '𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝 ??𝐥𝐦𝐚𝐬𝐫𝐲',url="t.me/DEV_AH8"}}
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
